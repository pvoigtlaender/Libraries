...
/// @brief Contains a particle system based on sf::Image. The module also provides several affector and emitter classes.
...
/// @brief Provides smart pointers with different ownership strategies.

/// @defgroup Time Time
/// @brief Supplies classes to measure time. These are convenient wrappers around sf::Clock.

/// @defgroup Tools Tools
/// @brief Reusable C++ utility features, for instance multimethods (dynamic dispatch).

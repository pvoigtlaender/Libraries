...
/// @brief Checks two edges for intersection.
/// @details If one of the endpoints is equal, this doesn't count as intersection.
/// @param lhs First edge
/// @param rhs Second edge
/// @return true, if the edges intersect anywhere except at the endpoints.
template <class VertexType>

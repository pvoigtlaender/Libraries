...
class THOR_API TargetEmitter : public Emitter
{
	...
	public:
		...
		/// @param zone Movable smart pointer to target zone. Every time a particle is emitted, a random point in the target
		///  zone is chosen, and the particle is accelerated towards that point.
	...
	// Private variables
	private:
		CopiedPtr<Zone, VirtualClone> mTargetZone;

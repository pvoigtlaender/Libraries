...
#ifdef _MSC_VER
	#define THOR_TR1_HEADER(Header) <Header>
#else
	#define THOR_TR1_HEADER(Header) <tr1/Header>
#endif // _MSC_VER


// Define DLL import/export macros (only Windows, and only dynamic configuration)
#if (defined(_WIN32) || defined(__WIN32__)) && !defined(THOR_STATIC)
...
#endif // (defined(_WIN32) || defined(__WIN32__)) && !defined(THOR_STATIC)


// Version of the library
#define THOR_VERSION_MAJOR 1
#define THOR_VERSION_MINOR 0


// Detail namespace (to avoid appearance in documentation)
#define THOR_DETAIL detail::
